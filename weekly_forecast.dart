...
class WeeklyForecast {
  ...
  factory WeeklyForecast.fromJson(Map<String, dynamic> json) {
    return WeeklyForecast(
      json['hourly']['time'] as List<int>,
      json['hourly']['temperature_2m'] as List<double>,
      json['hourly']['precipitation'] as List<double>,
      json['hourly']['windspeed_10m'] as List<double>,
    );
  }
...
Future<WeeklyForecast> GetWeather(lat, long) async {
    ...
    if (response.statusCode == 200) {
        return WeeklyForecast.fromJson(jsonDecode(response.body) as Map<String, dynamic>);
    } else {
